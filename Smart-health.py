...
cmdUtils = command_line_utils.CommandLineUtils("Smart Health Project - Send patient health data to AWS.")
...
cmdUtils.register_command("client_id", "<str>", "Client ID to use for MQTT connection (optional, default='test-*').", default="raspberry_pi")
...
if __name__ == '__main__':
    ...
    if message_string:
        ...
        while (publish_count <= message_count) or (message_count == 0):
            message = f"Patient {publish_count} : health data"
